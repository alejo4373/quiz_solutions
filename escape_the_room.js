 ...
 * @return {string[]}
 */
 //Moves the item from the object to the player's inventory 
 ...
 * @function useItem
 * @param  {string} item
 * @return {boolean} //It returns a new Result object not a boolean (AJ note)
 */
...
var myArrOfObjects = [	new RoomObject("Chair", "A regular wooden chair with something on it's seat", ["envelope"], [], [ "examine", "look"]),
						new RoomObject("Desk", "Desk where you can read and write letters", ["letter",": The key is in your reflection",], ["envelope"], ["examine", "sit", "read"]),
						new RoomObject("Door", "A heavy locked metal door", ["Exit ticket"], ["key"], ["examine","open"]),
						new RoomObject("bed", "Fancy queen-sized bed",["A 15 minute nap"],[], ["lay-down", "sleep", "nap"]),
						new RoomObject("vanity", "A vanity with a mirror, drawers and a chair", ["key"],["letter"],["look"])
					]

// Create an array of Room objects
var myArrOfRooms = new Room (myArrOfObjects)


// Create a new Game
var myGame = new Game(myArrOfRooms)

// Create a new Player
var player = new Player(myArrOfRooms)
